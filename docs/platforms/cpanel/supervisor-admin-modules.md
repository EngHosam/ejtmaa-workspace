...
**Implemented in the current frontend:** Login, empty Home, UiMockup, Error.
...
| `Home` | `/` | Authenticated MAIN shell; page body is empty |
| `UiMockup` | `/ui-mockup` | Engineering review of shared UI DNA |
...
Supervisor GQL (`supervisor.graphql`) already includes customer list/detail/stats, organizations, `me`, and notifications.
