...
| [`organization-host-routing.md`](organization-host-routing.md) | Apex vs organization host: boot split, `orgHostOnly` gate, Meeting `/meeting` session + linking gate + in-shell `MeetingPage` |
...
| Customer home | [`flow-customer-shell.md`](flow-customer-shell.md) §7 | Customer command map |
...
| `src/types/gql/definitions/customer.graphql` | Customer SDL (`_Me` + nested `organization` / `currentSubscription`, `_Organization`, `_Member`, `_MemberFilter`, `_MessageChannel`, `_MessageTemplate`, `_Meeting`, `_MeetingParticipant`, `_AgendaItem`, `_Decision`, `_Vote`, `_TalkRecord`, `_Plan`, `_Subscription`, `_AdwhatsAccount`, `_AdwhatsProAccount`, `_AdwhatsProApprovedTemplate`, `Query { me, notifications, members(filter), member, messageChannels, messageChannel, messageTemplates, messageTemplate, meetings, meeting, plans, plan, subscriptions, subscription, subscriptionPaymentMethods, adwhatsAccounts, adwhatsProAccounts, adwhatsProApprovedTemplates }` — no root `organization`; nested `_Subscription.plan`, `_Meeting.participants`, `_Meeting.agendaItems`, `_Meeting.decisions`, `_Decision.votes`, `_Meeting.talkRecords`) | `graphql-mirror-and-tooling.md` §2; `repository-inventory.md` § GQL mirrors; `flow-customer-members.md`; `flow-customer-organization.md`; `flow-customer-message-channels.md`; `flow-customer-message-templates.md` |
...
| Tile copy: ??????? / ???????? | `flow-customer-shell.md` §10 |
...
Current-state reflection of the customer-home change set. The source behavior is specified in `flow-customer-shell.md` §7; this table accounts for every changed file in the nested `website/` repository and the root documentation repository.

| Path | Documented where |
|---|---|
| `website/src/app/ui/pages/customer/CustomerHome.tsx` | `flow-customer-shell.md` §7 Entry and Component ownership |
| `website/src/app/ui/components/customer/hooks/useCustomerHome.ts` | `flow-customer-shell.md` §7 Data, Runtime and failure behavior, and Component ownership |
| `website/src/app/ui/components/customer/home/CustomerHomeScreen.tsx` | `flow-customer-shell.md` §7 Entry, Runtime and failure behavior, and Component ownership |
| `website/src/app/ui/components/customer/home/CustomerHomeCommandHero.tsx` | `flow-customer-shell.md` §7 Zones and Component ownership |
| `website/src/app/ui/components/customer/home/CustomerHomeFeaturedCta.tsx` | `flow-customer-shell.md` §7 Zones and Component ownership |
| `website/src/app/ui/components/customer/home/CustomerHomeStatusCard.tsx` | `flow-customer-shell.md` §7 Zones and Component ownership |
| `website/src/app/ui/components/customer/home/HomeZoneShell.tsx` | `flow-customer-shell.md` §7 Landing motif reuse and Component ownership |
| `website/src/app/ui/components/customer/home/WorkspaceLifecycleRail.tsx` | `flow-customer-shell.md` §7 Zones and Component ownership |
| `website/src/app/ui/components/customer/home/HomeAttentionList.tsx` | `flow-customer-shell.md` §7 Zones and Component ownership |
| `website/src/app/ui/components/customer/home/HomeReadinessStratum.tsx` | `flow-customer-shell.md` §7 Zones and Component ownership |
| `website/src/app/ui/components/customer/home/HomeAgendaStrip.tsx` | `flow-customer-shell.md` §7 Zones and Component ownership |
| `website/src/app/ui/components/customer/home/HomeActionStatusCards.tsx` | `flow-customer-shell.md` §7 Zones and Component ownership |
| `website/src/app/ui/components/customer/home/HomeFocusVisual.tsx` | `flow-customer-shell.md` §7 Runtime and failure behavior and Component ownership |
| `website/src/app/ui/components/customer/meetings/CustomerMeetingCard.tsx` | `flow-customer-shell.md` §7 Component ownership; `flow-customer-meetings.md` §6 home cross-link |
| `website/src/resources/translations/ar.ts` | `flow-customer-shell.md` §7 i18n |
| `website/src/resources/translations/en.ts` | `flow-customer-shell.md` §7 i18n |
...
| `docs/platforms/website/flow-customer-meetings.md` | §6 home cross-link and details ownership boundary. |
| `docs/platforms/website/flow-customer-shell.md` | §7 is the behavior, runtime, and component contract. |
...
| Live meeting document (Yjs + SyncedStore) + `useMeetingLiveMe` + linking gate (`MeetingLiveLinking`) | `organization-host-routing.md` §5.1, §5.2, §5.3, §8; `../backend/contracts/meeting-live-state.md` (§1.2 / §9) |
...
| Broadcast A/V client (`useMeetingLiveKitRoom` + `MeetingLiveBroadcast`, camera/mic/sound, cooperative mute-all, raise-hand control + tile queue badges, stage scroll + floating controls, media ceilings) | `flow-meeting-broadcast.md`; `organization-host-routing.md` §5.5, §8, §10m, §10q |
