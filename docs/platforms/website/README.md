...
| `src/types/gql/definitions/customer.graphql` | Customer SDL (`_Me`, `Query { me, notifications }`) | `graphql-mirror-and-tooling.md` §2; `repository-inventory.md` § GQL mirrors |
