...
| `src/types/gql/definitions/customer.graphql` | Customer SDL (`_Me`, `_Organization`, `Query { me, notifications, organization }`) | `graphql-mirror-and-tooling.md` §2; `repository-inventory.md` § GQL mirrors |
