...
| `src/types/gql/definitions/customer.graphql` | Customer SDL (`_Me`, `_Organization`, `_Member`, `Query { me, notifications, organization, members, member }`) | `graphql-mirror-and-tooling.md` §2; `repository-inventory.md` § GQL mirrors |
