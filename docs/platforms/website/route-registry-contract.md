...
|----------|------|--------|--------|
| `Meeting` | `/meeting/:memberId/:memberToken/:meetingId` | `MEETING` | organization-host meeting shell + layout-owned `/meeting` socket (`MeetingLiveProvider`) — `organization-host-routing.md` §5 |
