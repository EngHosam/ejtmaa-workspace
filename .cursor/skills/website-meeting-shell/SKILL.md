...
description: >-
  ...
  MeetingInitPage lobby + drawer page stubs, and header request-to-speak for
  non-chair. Use when editing MeetingDrawerPanel, MeetingHeader, MeetingInitPage
  / MeetingPageStub under meeting/pages, useMeetingPage, useOrganization,
  HomeMark color overrides for meeting wells, Meeting.tsx, or MeetingLayout
